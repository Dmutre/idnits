...
export async function checkNits (raw, filename, {
  ...
  if (doc.type === 'txt') {
    ...
    if (doc.docKind !== 'rfc') {
      progressReport('Validating page lenght...')
      ...
      progressReport('Validating acceptable paragraph pointing to the list of current ids...')
      result.push(...(await validateAcceptableParagraphPointingListIds(doc, { mode })))
