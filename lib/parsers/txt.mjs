...
const licenseDeclarations = {
  ...
  copyright_section6: /Copyright\s+\(c\)\s+(\d{4})\s+IETF Trust|Copyright\s+\(C\)\s+The Internet Society\s+\((\d{4})\)/gi,
  copyright_license: /This document is subject to BCP 78 and the IETF Trust's Legal Provisions|This document may not be modified, and derivative works of it may not be created/gi
}
