...
const licenseDeclarations = {
  ...
  acceptable_paragraph_noting_that_draft: /Internet-Drafts are working documents of the Internet Engineering\s*Task Force \(IETF\)\./gi,
...
export async function parse (rawText, filename) {
  ...
  try {
    ...
    data.contains.draftParagraphPointingToTheListOfCurrentIds = licenseDeclarations.draft_paragraph_pointing_to_the_list_of_current_ids.test(normalizedText)
