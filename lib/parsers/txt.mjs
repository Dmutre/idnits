...
export async function parse (rawText, filename) {
  ...
  try {
    ...
    data.contains.revisedBsdLicense6_i = licenseDeclarations.revised_bsd_license6_i.test(normalizedText)
    data.contains.licencse6_b_iii = licenseDeclarations.ietf_contributions_license6_c_iii.test(normalizedText)
